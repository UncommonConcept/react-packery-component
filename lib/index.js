...
var Packery = isBrowser ? window.Packery || require('packery') : require('packery');
var Draggabilly = isBrowser ? window.Draggabilly || require('draggabilly') : require('draggabilly');
var imagesloaded = isBrowser ? require('imagesloaded') : require('imagesloaded');
